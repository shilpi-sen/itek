...
function itek_customize_register( $wp_customize ) {
   ...
   $wp_customize->add_section( 'itek_theme_notes' , array(
	...
	/*color-scheme*/    
        $wp_customize->add_section( 'itek_color_scheme_settings', array(
		'title'       => __( 'Color Scheme', 'itek' ),
		'priority'    => 30,
		'description' => 'Select your color scheme',
	) );

	$wp_customize->add_setting( 'itek_color_scheme', array(
		'default'        => 'red',
	) );

	$wp_customize->add_control( 'itek_color_scheme', array(
		'label'   => 'Choose your color scheme',
		'section' => 'itek_color_scheme_settings',
		'default'        => 'red',
		'type'       => 'radio',
		'choices'    => array(
			__( 'blue', 'locale' ) => 'blue',
